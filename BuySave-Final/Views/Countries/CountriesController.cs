...
namespace BuySave_Final.Views.Countries
{
    public class CountriesController : Controller
    {
        ...
        public CountriesController(BuySave_FinalDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Country != null ? 
                          ...
                          Problem("Entity set 'BuySave_FinalDbContext.Country'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BuySave_FinalDbContext.Country'  is null.");
            }
            var country = await _context.Country.FindAsync(id);
            if (country != null)
            {
